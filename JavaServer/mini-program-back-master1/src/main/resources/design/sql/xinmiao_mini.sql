...
CREATE TABLE `user`  (
  ...
  `user_passwd` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `user_wx` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
